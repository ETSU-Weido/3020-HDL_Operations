...
CREATE TABLE Employee (
  ...
  CONSTRAINT chkEmployeeHourlyRate   
...
CREATE TABLE Customer (
  ...
  name           VARCHAR(50),
  phoneNumber    VARCHAR(50) CHECK (length (phoneNumber)= 12)
  emailAddress   VARCHAR (254)
  creationDate   DATE NOT NULL DEFAULT, 
  membershipFlag INTEGER NOT NULL DEFAULT 0,
  CONSTRAINT chkCustomerMembershipFlag CHECK (membershipFlag IN (0,1))
);

-- One preferred address per customer deferred to Lab 3 (rule 2). ******************UPDATE ERD*****************************************
...
CREATE TABLE SalesTransaction (
  ...
  dateTime      VARCHAR(50)    NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE RentalUnit (
  ...
  rentalModel     VARCHAR(50)    NOT NULL,
  category        VARCHAR(50)    NOT NULL,
...
CREATE TABLE ContractExtension (
  ...
  contractId    INTEGER NOT NULL,
  extensionDate VARCHAR(50)    NOT NULL,
  cost          NUMERIC NOT NULL,
...
CREATE TABLE RentalUnitTransfer (
  ...
  transferDateTime VARCHAR(50)    NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE RentalReturn (
  ...
  rentalAssetTag  INTEGER NOT NULL,
  conditionStatus VARCHAR(50)    NOT NULL,
  returnDateTime  VARCHAR(50)    NOT NULL DEFAULT (datetime('now')),
